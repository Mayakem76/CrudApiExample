package kemy.dev.CrudApiExample.config;
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .build().apiInfo(new ApiInfo(
                        "Crud Api Example",//  title
                        "  Example of Crud Api with swagger API documentation  ", //   description
                        "1.0.0",// version
                        " https://it.wikipedia.org/wiki/Licenza_MIT",//termsOfServiceUrl
                        new Contact("Kemonia","https://github.com/Mayakem76/CrudApiExample","kemonia_j@yahoo.it"),//Contact contact
                        "MIT",//license
